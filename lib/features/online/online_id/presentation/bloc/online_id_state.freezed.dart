...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OnlineIdState);
}
...
/// @nodoc
class $OnlineIdStateCopyWith<$Res>  {
$OnlineIdStateCopyWith(OnlineIdState _, $Res Function(OnlineIdState) __);
}


/// Adds pattern-matching-related methods to [OnlineIdState].
extension OnlineIdStatePatterns on OnlineIdState {
...
class _Initial implements OnlineIdState {
  const _Initial();
...
class _Loading implements OnlineIdState {
  const _Loading();
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $OnlineIdStateCopyWith<$Res> {
...
class _Error implements OnlineIdState {
...
@override
String toString() {
  return 'OnlineIdState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $OnlineIdStateCopyWith<$Res> {
