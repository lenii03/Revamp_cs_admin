...
import '../../data/models/report_reset_pin_code_model.dart';

class ReportResetPinCodePage extends StatefulWidget {
  const ReportResetPinCodePage({super.key});

  @override
  State<ReportResetPinCodePage> createState() => _ReportResetPinCodePageState();
}

class _ReportResetPinCodePageState extends State<ReportResetPinCodePage> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // --- 3. DATA TABLE ---
          Expanded(
            child: _buildTable([]), // Sementara list kosong sampai BLoC siap
          ),
        ],
      ),
    );
  ...
  Widget _buildTable(List<ReportResetPinCodeModel> dataList) {
    // 1. Definisikan Kolom
